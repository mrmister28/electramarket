...
if(isset($_POST['update'])){
   ...
   $update_product->execute([$name, $price, $details, $product_id]);
   ...
   if(!empty($image_01)){
      if($image_size_01 > 2000000){
         ...
         $update_image_01 = $conn->prepare("UPDATE `products` SET image_01 = ? WHERE product_id = ?");
   ...
   if(!empty($image_02)){
      if($image_size_02 > 2000000){
         ...
         $update_image_02 = $conn->prepare("UPDATE `products` SET image_02 = ? WHERE product_id = ?");
   ...
   if(!empty($image_03)){
      if($image_size_03 > 2000000){
         ...
         $update_image_03 = $conn->prepare("UPDATE `products` SET image_03 = ? WHERE product_id = ?");
